...
def setup_admin(bot):
    ...
    def git_upload(call):
        ...
        subprocess.run(["/bin/bash", "/home/deaaad/Vpizkabot/update_bot.sh"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    def restart_bot(call):
        ...
        subprocess.run(["/bin/bash", "/home/deaaad/Vpizkabot/restart_bot.sh"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    def stop_bot(call):
        ...
        subprocess.run(["/bin/bash", "/home/deaaad/Vpizkabot/stop_bot.sh"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
